    ...
    <footer className="bg-gray-900 text-gray-400 py-8">
      <div className="container mx-auto px-6 lg:px-16 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="mt-4 text-gray-500">
            Prikaži svoje dogodke Sloveniji. Naš cilj je povezati mlade in
            dogodke, ki jih zanimajo.
          </p>
        </div>
        ...
        <div className="text-center md:text-left">
          ...
          <ul className="space-y-2">
            <li>
              <Link to="/#onas" className="hover:text-white transition">
                O nas
              </Link>
            </li>
            <li>
              <Link to="/#narocnine" className="hover:text-white transition">
                Naročnine
              </Link>
            </li>
            <li>
      ...
      <div className="mt-8 text-center border-t border-gray-700 pt-4">
        <p className="text-gray-500">
          © {new Date().getFullYear()} Študentski Dogodki. Vse pravice
          pridržane.
        </p>
      </div>
    </footer>
