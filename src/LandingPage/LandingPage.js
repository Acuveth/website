...
const LandingPage = () => {
  return (
    <>
      <div className="flex flex-col md:flex-row items-center min-h-screen bg-gray-900 text-white p-8 md:p-16">
        ...
        <div className="ml-8 w-full md:w-1/2 space-y-6">
          ...
          {/* Call to Action */}
          <button className="mt-4 bg-transparent border-2 border-custom-orange text-white text-lg hover:bg-custom-orange hover:text-white font-semibold py-3 px-32 rounded-md transition duration-300">
  Začni
</button>
        </div>
